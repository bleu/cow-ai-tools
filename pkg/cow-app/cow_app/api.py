"""
Minimal chat API for CoW Protocol: health check + /predict.
Uses cow_brains for RAG (docs, Order Book API, CoW Swap, CoW SDK).
"""
import os
import time
...
from rag_brains.exceptions import UnsupportedVectorstoreError
